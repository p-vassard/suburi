...
export class Achievements {
    ...
    initialize() {
        this.list.push(new HitRequirement(HitTypes.MEN, "Men, c'est la base", "Faire 10 Men", 10, 1));
        this.list.push(new HitRequirement(HitTypes.MEN, "Quelle autre frappe ?", "Faire 100 Men", 100, 5));
        this.list.push(new HitRequirement(HitTypes.MEN, "On peut tout gagner avec des Men", "Faire 1 000 Men", 1000, 15));
        this.list.push(new HitRequirement(HitTypes.MEN, "L'air a mal au crâne", "Faire 10 000 Men", 10000, 30));
        this.list.push(new HitRequirement(HitTypes.MEN, "Plus vite je frapperai, plus vite j'aurai atteint les 100 000", "Faire 100 000 Men", 100000, 100));

        this.list.push(new HitRequirement(HitTypes.KOTE, "Kote, l'autre frappe", "Faire 10 Kote", 10, 1));
        this.list.push(new HitRequirement(HitTypes.KOTE, "Avec ou sans Kote ?", "Faire 100 Kote", 100, 5));
        this.list.push(new HitRequirement(HitTypes.KOTE, "Ne jamais mettre cette frappe de côté", "Faire 1 000 Kote", 1000, 15));
        this.list.push(new HitRequirement(HitTypes.KOTE, "It's over 9000!", "Faire 10 000 Kote", 10000, 30));
        this.list.push(new HitRequirement(HitTypes.KOTE, "Vas-y, lance Men pour voir", "Faire 100 000 Kote", 100000, 100));

        this.list.push(new HitRequirement(HitTypes.DO, "Dôôôôôô", "Faire 10 Do", 10, 1));
        this.list.push(new HitRequirement(HitTypes.DO, "J'aime le son que produit Do", "Faire 100 Do", 100, 5));
        this.list.push(new HitRequirement(HitTypes.DO, "Cette frappe est trop classe", "Faire 1 000 Do", 1000, 15));
        this.list.push(new HitRequirement(HitTypes.DO, "Hé, on peut la faire des deux côtés !", "Faire 10 000 Do", 10000, 30));
        this.list.push(new HitRequirement(HitTypes.DO, "J'espère que ton armure est solide", "Faire 100 000 Do", 100000, 100));

        this.list.push(new HitRequirement(HitTypes.TSUKI, "Tsukiiii", "Faire 10 Tsuki", 10, 1));
        this.list.push(new HitRequirement(HitTypes.TSUKI, "Vise bien stp ^^'", "Faire 100 Tsuki", 100, 5));
        this.list.push(new HitRequirement(HitTypes.TSUKI, "Toujours plus vite, toujours plus fort", "Faire 1 000 Tsuki", 1000, 15));
        ...
        this.list.push(new SuburiConsecutiveDaysRequirement(100, "J'aime", "Faire 100 suburi 365 jours de suite", 365, 350));

        this.list.push(new SuburiConsecutiveDaysRequirement(500, "Des épaules en fer", "Faire 500 suburi 7 jours de suite", 7, 35));
        this.list.push(new SuburiConsecutiveDaysRequirement(500, "Des épaules en acier", "Faire 500 suburi 30 jours de suite", 30, 125));
        this.list.push(new SuburiConsecutiveDaysRequirement(500, "Des épaules en adamantium", "Faire 500 suburi 365 jours de suite", 365, 550));

        this.list.push(new SuburiConsecutiveDaysRequirement(1000, "Préparation pour le summer body", "Faire 1000 suburi 7 jours de suite", 7, 75));
        this.list.push(new SuburiConsecutiveDaysRequirement(1000, "Préparation pour les JO", "Faire 1000 suburi 30 jours de suite", 30, 200));
        this.list.push(new SuburiConsecutiveDaysRequirement(1000, "Préparation pour combattre les martiens", "Faire 1000 suburi 365 jours de suite", 365, 1500));
    }

    getScore(): number
    {
        return this.alreadyAchieved.reduce((sum: number, req: Requirement) => sum + req.score, 0);
    }
